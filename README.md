...
Marketing site for **Omniscient AI** — Australia's specialists in enterprise AI adoption.
Sovereign, on-premises AI: working solutions, not training courses.

## Stack

Deliberately none. One self-contained `index.html` — inline CSS/JS, no build step, no
framework, no external dependencies beyond Google Fonts. Fast, auditable, and hostable
anywhere (currently GitHub Pages).
...
- **The Ledger Collapse** — drag variable cloud spend into a fixed cost (~50% typical reduction, honestly hedged).
...
configure.html        AUD deployment configurator (behind book-a-meeting gate)
assets/               brand imagery, generated films + posters, downloadable collateral (PDFs, value calculator)
```
